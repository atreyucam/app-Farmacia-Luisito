...
const Compra_Proveedor = sequelize.define('Compra_Proveedor',{
    id_CompraProveedor:{type:DataTypes.INTEGER, primaryKey: true, autoIncrement: true},
...
Proveedor.hasMany(Compra_Proveedor,{as:'ProveedorCompras', foreignKey:'id_proveedor'});
Compra_Proveedor.belongsTo(Proveedor,{foreignKey:'id_proveedor'});

//Tabla Detalle_Compra_Proveedores
const Detalle_CompraProveedor = sequelize.define('Detalle_CompraProveedor',{
    id_compraDetalle:{type: DataTypes.INTEGER, primaryKey: true, autoIncrement:true},
    cantidad: {type: DataTypes.INTEGER, allowNull: false},
    precioUnidad: {type: DataTypes.DECIMAL, allowNull: false}
},{tableName:'detalle_CompraProveedores'});
Compra_Proveedor.hasMany(Detalle_CompraProveedor, { as: 'DetalleCompraProveedores', foreignKey: 'id_compraProveedor' });
Detalle_CompraProveedor.belongsTo(Compra_Proveedor, { foreignKey: 'id_compraProveedor' });
Producto.hasMany(Detalle_CompraProveedor,{as:'DetalleCompraProducto', foreignKey:'id_producto'});
